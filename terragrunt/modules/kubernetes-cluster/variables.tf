...
# variable "on_demand_node_disk_size_gb" {
#   description = "The disk size in GB for the on-demand nodes"
#   type        = number
#   default     = 50
# }

# variable "on_demand_node_disk_type" {
#   description = "The disk type for the on-demand nodes"
#   type        = string
#   default     = "pd-standard"
# }
